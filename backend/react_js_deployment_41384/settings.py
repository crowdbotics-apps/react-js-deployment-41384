"""
Django settings for react_js_deployment_41384 project.
...
ROOT_URLCONF = 'react_js_deployment_41384.urls'
...
WSGI_APPLICATION = 'react_js_deployment_41384.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "react_js_deployment_41384 API",
    "DESCRIPTION": "API documentation for react_js_deployment_41384 App",
    "VERSION": "v1",
}
