...
## Project Structure
    ...
    ├── react_js_deployment_41384  # Django project configurations
...
1. Clone this repo and `cd react_js_deployment_41384`
...
2. Clone this repo and `cd react_js_deployment_41384`
